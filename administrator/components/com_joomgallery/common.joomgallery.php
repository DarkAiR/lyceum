...
// $Id: common.joomgallery.php 457 2009-07-26 10:38:28Z aha $
/******************************************************************************\
**   JoomGallery  1.5                                                         **
...
function Joom_Chmod($dir, $mode = 0644) {
  //check if chmod is necessary, otherwise return true  
  $fileperms= substr(decoct( fileperms($dir)),3);
  if ($fileperms >= decoct($mode)){
    return true;
  }
 ...
 */
function Joom_StringCutting($scString,$scMaxlength,$atspace='true')  
{  
